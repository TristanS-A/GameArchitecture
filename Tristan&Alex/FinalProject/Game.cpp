...
{
	const string LOCAL_ASSET_PATH = "..\\..\\Tristan&Alex\\assets\\";
...
void Game::loadDataFromFile()
{
	...
	file;
	file.open("..\\..\\Tristan&Alex\\assets\\textHolder.txt");
	data = "";
...
void Game::loadNPCDiologue()
{
	int currNPC;
	ifstream file;
	file.open("..\\..\\Tristan&Alex\\assets\\NPCDiologue.txt");
	string data;
...
void Game::saveGame()
{
	const string SAVE_FILE_PATH = "..\\..\\Tristan&Alex\\assets\\saveGame.txt";
